                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        id="discountValue" name="discountValue" placeholder="0" min="0"
                                                                        required>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    <label for="maxDiscount" class="form-label">Giảm tối
                                                                        đa (VNĐ)</label>
                                                                    <input type="number" class="form-control"
                                                                        id="maxDiscount" name="maxDiscount" placeholder="0" min="0">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="usageLimit" class="form-label">Giới hạn
                                                                        sử dụng</label>
                                                                    <input type="number" class="form-control"
                                                                        id="usageLimit" name="usageLimit" placeholder="Không giới hạn"
                                                                        min="1">
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="datetime-local" class="form-control"
                                                                        id="startDate" id="startDate" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
