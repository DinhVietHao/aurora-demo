...
<head>
    ...
    <link rel="stylesheet" href="assets/styles/promotionCreate.css">
</head>
<body class="sb-nav-fixed">
    <header class="header">
        <div class="container">
            <div class="row header-content">
                <div class="col-3 col-md-1 header-logo">
                    <a href="./home.html">
                        <img src="./assets/images/logo-header.png" alt="Logo" style="height:60px; width:auto;">
                    </a>
                </div>
                ...
                <div class="col-3 col-md-4">
                    <nav class="header-nav">
                        <a href="./home.html" class="header-nav-item header-mobile-disable">
                            <i class="bi bi-house"></i> <span>Trang chủ</span>
                        </a>
                        <a href="./book.html" class="header-nav-item header-mobile-disable">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="shopInfo.html">Quản lý shop</a></li>
                                <li><a class="dropdown-item" href="productManagement.html">Quản lý sản phẩm</a></li>
                                <li><a class="dropdown-item" href="orderManagement.html">Quản lý đơn hàng</a></li>
                                <li><a class="dropdown-item" href="promotionManagement.html">Quản lý khuyến mãi</a></li>
                        ...
                        <button class="btn btn-outline-primary btn-sm ms-2" id="sidebarToggle" type="button">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="promotionManagement.html">Khuyến mãi</a></li>
                                ...
                                <div class="card-body">
                                    <form id="createVoucherForm">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="voucherCode" placeholder="VD: NEWUSER50" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="voucherName" placeholder="VD: Voucher cho người dùng mới" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="discountValue" placeholder="0" min="0" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="maxDiscount" class="form-label">Giảm tối đa (VNĐ)</label>
                                                    <input type="number" class="form-control" id="maxDiscount" placeholder="0" min="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="minOrderValue" class="form-label">Đơn hàng tối thiểu (VNĐ)</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="usageLimit" placeholder="Không giới hạn" min="1">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="voucher-preview">
                                        <div class="voucher-preview-card">
                                            <div class="voucher-header">
                                                <div class="voucher-code-preview" id="previewCode">VOUCHER_CODE</div>
                                                <div class="voucher-type-preview" id="previewType">%</div>
                                            </div>
                                            <div class="voucher-body">
                                                <div class="voucher-name-preview" id="previewName">Tên voucher</div>
                                                <div class="voucher-discount-preview" id="previewDiscount">0%</div>
                                                <div class="voucher-condition-preview" id="previewCondition">Đơn tối thiểu: 0 VNĐ</div>
                                            </div>
                                            <div class="voucher-footer">
                                                <div class="voucher-date-preview" id="previewDate">Chưa có thời hạn</div>
                                                <div class="voucher-usage-preview" id="previewUsage">Không giới hạn</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
