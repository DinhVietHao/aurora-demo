        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
                ...
                <head>
                    ...
                    <link rel="stylesheet" href="${ctx}/assets/css/shop/promotionCreate.css">
                </head>
                                ...
                                <div class="col-6 col-md-6">
                                    <div class="header-search">
                                        ...
                                        <input type="text" class="form-control rounded-pill"
                                            placeholder="Hôm nay bạn mua gì ...">
                                    ...
                                    <nav class="header-nav">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="productManagement.html">Quản lý sản
                                                        phẩm</a></li>
                                                <li><a class="dropdown-item" href="orderManagement.html">Quản lý đơn
                                                        hàng</a></li>
                                                <li><a class="dropdown-item" href="promotionManagement.html">Quản lý
                                                        khuyến mãi</a></li>
                                                <li><a class="dropdown-item" href="adminDashboard.html">Dashboard</a>
                                                </li>
                                                <li>
                                        ...
                                        <button class="btn btn-outline-primary btn-sm ms-2" id="sidebarToggle"
                                            type="button">
