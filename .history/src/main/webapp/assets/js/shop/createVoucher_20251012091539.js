...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const maxDiscountContainer = document.getElementById("maxDiscount").closest(".mb-3");
  ...
  // Gọi ngay khi trang load (để xử lý mặc định)
  toggleDiscountFields();

  // Khi người dùng thay đổi loại giảm giá
