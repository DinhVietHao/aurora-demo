...
public class VoucherServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Double maxAmount = maxDiscountStr != null && !maxDiscountStr.isEmpty() ? Double.parseDouble(maxDiscountStr) : null;
            double minOrderAmount = Double.parseDouble(request.getParameter("minOrderValue"));
