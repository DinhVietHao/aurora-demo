<%@ page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <!-- Modal Register -->
        <div class="modal fade authFormModal" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel"
            aria-hidden="true">
                            ...
                            <div class="col-12 col-lg-6 auth-form-right">
                                <form class="auth-form-form" id="form-register">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="register-fullname" type="text" class="form-control"
                                    ...
                                    <div class="form-group mb-2">
                                        <label for="register-password-confirmation" class="form-label">Xác nhận mật
                                            khẩu</label>
                                        <div class="password">
                                    ...
                                    <div class="form-group mb-2">
                                        <label for="register-otp" class="form-label">Mã OTP</label>
                                        <label for="register-time" class="form-label" id="otp-timer"></label>
                                        <div class="input-group">
                                            <input id="register-otp" type="number" class="form-control"
                                                placeholder="Nhập mã OTP" />
                                            <button type="button" class="button-two" id="send-otp">
                                                Gửi OTP
                                            </button>
                                        </div>
                                        <span class="form-message"></span>
        ...
        <!-- Modal Login -->
        <div class="modal fade authFormModal" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="col-12 col-lg-6 auth-form-right">
                                <form class="auth-form-form" id="form-login">
                                        ...
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input tabindex="-1" class="form-check-input" type="checkbox"
                                                    id="rememberMe" />
                                                <label tabindex="-1" class="form-check-label" for="rememberMe">
                                                    Ghi nhớ đăng nhập
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-6 text-end">
                                            <a href="#" tabindex="-1" data-open="forget-password">Quên mật khẩu?</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-grid mb-3">
                                        <button id="btn-login-google" type="button" class="button-two">
        ...
        <div class="modal fade authFormModal" id="forgetPasswordModal" tabindex="-1"
                            ...
                            <div class="col-12 col-lg-12 auth-form-right forget-password">
                                ...
                                <form class="auth-form-form" id="form-forget-password">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="forget-password-email" name="email" type="email" class="form-control"
                                            placeholder="Nhập email của bạn" />
                                        <span class="form-message"></span>
                                    </div>
