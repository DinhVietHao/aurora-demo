        ...
        <main>
                            ...
                            <div class="container">
                                <div class="row align-items-center banner-content">
                                    <div class="col-lg-6 col-md-12 text-white px-4">
                                        ...
                                        <p>Khám phá hàng ngàn cuốn sách thuộc mọi thể loại. Từ những cuốn sách bán chạy nhất đến những viên ngọc ẩn, hãy tìm cuốn sách hoàn hảo của bạn với mức giá không thể cạnh tranh hơn.</p>
            ...
            <div class="suggest container">
                ...
                <div id="bookSuggest" class="carousel slide" data-bs-ride="false">
                                        ...
                                        <a href="${ctx}/book?id=${p.productId}">
                                            <div class="product-card">
                                                <div class="product-img">
                                                    <c:if test="${p.originalPrice != null && p.salePrice != null && p.originalPrice > p.salePrice}">
                                                        <span class="discount">
                    ...
                    <!-- Nút điều hướng -->
                    <button class="carousel-control-prev" type="button" data-bs-target="#bookSuggest" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon"></span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#bookSuggest" data-bs-slide="next">
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="product-card">
                            ...
                            <div class="product-body">
                                ...
                                <div class="rating">
                                    <i class="bi bi-star-fill text-warning small"></i><i class="bi bi-star-fill text-warning small"></i><i class="bi bi-star-fill text-warning small"></i><i class="bi bi-star-fill text-warning small"></i><i class="bi bi-star-half text-warning small"></i>
