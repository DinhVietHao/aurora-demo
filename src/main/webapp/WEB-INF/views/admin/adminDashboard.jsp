                                ...
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    <div class="d-flex align-items-center">
                                        <button id="sidebarToggle"
                                            class="btn btn-outline-secondary btn-sm me-3 d-lg-none" type="button"
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <c:if test="${pendingOrders > 0}">
                                                    <li><a class="dropdown-item"
                                                            href="<c:url value='/admin/orders?status=pending'/>">
                                                            <i class="bi bi-cart me-1"></i> ${pendingOrders} đơn hàng
                                                            đang chờ xử lý
                                                        </a></li>
                                                </c:if>
                                                <c:if test="${lowStockProducts > 0}">
                                                    <li><a class="dropdown-item"
                                                            href="<c:url value='/admin/products?lowStock=true'/>">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <div
                                                            class="stats-change ${revenueChangePercent >= 0 ? 'positive' : 'negative'}">
                                                            <fmt:formatNumber value="${revenueChangePercent}"
                                                                pattern="0.0" />%
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <div
                                                            class="stats-change ${orderChangePercent >= 0 ? 'positive' : 'negative'}">
                                                            <fmt:formatNumber value="${orderChangePercent}"
                                                                pattern="0.0" />%
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <div
                                                            class="stats-change ${productChangePercent >= 0 ? 'positive' : 'negative'}">
                                                            <fmt:formatNumber value="${productChangePercent}"
                                                                pattern="0.0" />%
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    <a href="<c:url value='/admin/orders'/>"
                                                        class="btn btn-sm btn-outline-primary">Quản lý đơn hàng</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    <a href="<c:url value='/admin/products'/>"
                                                        class="btn btn-sm btn-outline-success">Quản lý sản phẩm</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="small text-muted">
                                                    <fmt:formatNumber value="${revenue7Days}" type="currency"
                                                        currencySymbol="đ" maxFractionDigits="0" />
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                                ...
                                                                <c:when test="${activity.type eq 'order'}">
                                                                    ...
                                                                    <div class="activity-content">
                                                                        <div class="activity-title">
                                                                            <a
                                                                                href="<c:url value='/admin/orders/detail?id=${activity.id}'/>">
                                                                                Đơn hàng mới #${activity.id}
                                                                            </a>
                                                                        </div>
                                                                        <div class="activity-details">
                                                                            ${activity.name} -
                                                                            <fmt:formatNumber value="${activity.value}"
