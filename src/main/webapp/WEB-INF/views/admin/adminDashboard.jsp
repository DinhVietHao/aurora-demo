                        ...
                        <div class="col-12">
                            <div class="card border-success">
                                <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                                    <h5 class="mb-0">
                                        <i class="bi bi-cash-coin me-2"></i>Doanh Thu Hệ Thống
                                    </h5>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card bg-light h-100">
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="mt-2">Phí hoa hồng đơn hàng</h6>
                                                    <h3 class="text-warning mb-0">
                                                        <fmt:formatNumber value="${platformRevenue.totalOrderFees}" type="currency" currencySymbol="đ" maxFractionDigits="0"/>
                                                    </h3>
                                                    <small class="text-muted">Phí % theo đơn hàng</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="alert alert-info mt-3 mb-0">
                                        ...
                                        <strong>Công thức:</strong> Doanh thu hệ thống = Thuế VAT + Phí hoa hồng đơn hàng
                                        <a href="<c:url value='/admin/setting-management'/>" class="float-end">
                                            <i class="bi bi-gear me-1"></i>Cấu hình phí
                                        </a>
                                    </div>
                                </div>
                            </div>
