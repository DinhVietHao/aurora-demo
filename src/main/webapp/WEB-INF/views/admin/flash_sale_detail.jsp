                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="<c:url value='/'/>">Trang chủ</a>
                                                </li>
                                                <li class="breadcrumb-item"><a
                                                        href="<c:url value='/admin/flash-sales'/>">Flash sale</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <small class="text-muted ms-3">Tạo lúc:
                                                    <fmt:formatDate value="${fs.createdAt}"
                                        ...
                                        <div class="row g-3 align-items-end">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-select" name="sort">
                                                    ...
                                                    <option value="price_desc" ${sort=='price_desc' ? 'selected' : '' }>
                                                        Giá cao → thấp</option>
                                                    <option value="name_asc" ${sort=='name_asc' ? 'selected' : '' }>Tên
                                                        A → Z</option>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-select" name="pageSize">
                                                    <option value="12" ${pageSize==12 ? 'selected' : '' }>12 sản phẩm
                                                    </option>
                                                    <option value="24" ${pageSize==24 ? 'selected' : '' }>24 sản phẩm
                                                    </option>
                                                    <option value="48" ${pageSize==48 ? 'selected' : '' }>48 sản phẩm
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-2">
                                                <a href="<c:url value='/admin/flash-sales/approval'/>"
                                        ...
                                        <c:choose>
                                            <c:when test="${empty items}">
                                                <div class="text-center py-5">
                                                    ...
                                                    <p class="text-muted">Thử điều chỉnh bộ lọc để tìm kiếm sản phẩm
                                                        khác</p>
                                                </div>
                                            </c:when>
                                            <c:otherwise>
                                                        ...
                                                        <div class="col-6 col-md-4 col-lg-3">
                                                            <div class="product-card">
                                                                <div class="product-img">
                                                                    <span class="discount">
                                                                        <fmt:formatNumber
                                                                            value="${((p.originalPrice.doubleValue() - p.flashPrice.doubleValue()) / p.originalPrice.doubleValue()) * 100}"
                                                                            pattern="#,##0" maxFractionDigits="0" />%
                                                                    </span>
                                                                    <img src="<c:url value='/assets/images/product-${(loop.index % 3) + 1}.png'/>"
                                                                        alt="${p.title}">
                                                                </div>
                                                                <div class="product-body">
                                                                    <h6 class="price">
                                                                        <fmt:formatNumber value="${p.flashPrice}"
                                                                    ...
                                                                    <div class="mt-1">
                                                                        <small class="text-muted"><i
                                                                                class="bi bi-shop me-1"></i>${p.shopName}</small>
                                                                    </div>
                                                    ...
                                                    <nav aria-label="pagination" class="mt-4">
                                                        <ul class="pagination justify-content-center">
                                                            <li class="page-item ${page==1?'disabled':''}">
                                                                <a class="page-link"
                                                                    href="?id=${fs.flashSaleId}&name=${name}&publisher=${publisher}&price=${price}&sort=${sort}&page=${page-1}&pageSize=${pageSize}">‹</a>
                                                            </li>
                                                            <c:forEach var="pnum" begin="1" end="${totalPages}">
                                                                <li class="page-item ${pnum==page?'active':''}">
                                                                    <a class="page-link"
                                                                        href="?id=${fs.flashSaleId}&name=${name}&publisher=${publisher}&price=${price}&sort=${sort}&page=${pnum}&pageSize=${pageSize}">${pnum}</a>
                                                                </li>
                                                            </c:forEach>
