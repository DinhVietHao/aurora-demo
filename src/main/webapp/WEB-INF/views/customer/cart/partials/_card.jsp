  ...
  <%@ taglib prefix="c" uri="jakarta.tags.core" %>
    ...
    <div class="col-6 col-md-4 col-lg-2">
      <div class="product-card">
        <a href="${ctx}/home?action=detail&id=${param.id}">
          <div class="product-img">
            <c:if test="${not empty param.discount}">
              <span class="discount">-${param.discount}%</span>
            </c:if>
            <img src="${empty param.img ? (ctx + '/assets/images/catalog/products/product-1.png') : param.img}"
              alt="Sách" />
          </div>
        </a>
        <div class="product-body">
          ...
          <div class="rating">
            ...
            <span>Đã bán
              <c:out value="${empty param.sold ? 0 : param.sold}" />
            </span>
          </div>
        </div>
      </div>
