...
<html lang="vi">
    <head>
        ...
        <link
            rel="stylesheet"
            href="./assets/css/customer/profile/information_account.css?v=1.0.1"
        />
    </head>
                    ...
                    <ul class="nav mb-3 " id="profileTabs" role="tablist">
                        ...
                        <li class="nav-item mb-2">
                            <a class="nav-link text-dark" href="/order">
                                <i class="bi bi-box-seam me-2"></i> Quản lý đơn
                                hàng
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="profileTabsContent">
                        ...
                        >
                            <div class="text-center mt-5">
                                <img
                                    src="./assets/images/mascot_fail.svg"
                                    alt=""
                                />
                        ...
                        >
                            <div class="profile">
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        class="col-md-4 text-center profile-update__img"
                                    >
                                        <div class="mb-3">
                                            <img
                                                src="./assets/images/common/avatar.png"
