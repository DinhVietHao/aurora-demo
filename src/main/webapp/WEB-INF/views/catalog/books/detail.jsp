                ...
                <div class="col-md-5">
                    <div class="book-detail-images">
                        <div class="product-image mb-3">
                            <img id="mainImage"
                                 src="http://localhost:8080/aurora/assets/images/${product.images[0].imageUrl}"
                        ...
                        <div class="row g-2 mb-3">
                            <c:forEach var="img" items="${product.images}" varStatus="s">
                                <c:if test="${!s.last}">
                                    <div class="col-3">
                                        <img src="http://localhost:8080/aurora/assets/images/${img.imageUrl}" 
                ...
                <div class="col-md-7">
                    <div class="book-detail-header">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="price"><fmt:formatNumber value="${finalPrice}" type="currency" currencySymbol="đ" groupingUsed="true"/></span>
                    ...
                    <div class="book-information my-3">
                        ...
                        <div class="book-information-body">
                            ...
                            <div class="row mb-1 book-information-box">
                                ...
                                <div class="col-7"><c:out value="${product.sku}"/></div>
                            </div>
                            <div class="row mb-1 book-information-box">
                            ...
                            <div class="row mb-1 book-information-box">
                                ...
                                <div class="col-7"><c:out value="${product.publisher}"/></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        <div class="book-description">
                            ...
                            <div class="book-description-body">
                                ...
                                <p class="collapse" id="moreText">
                                    <c:out value="${product.description}"/>
                                </p>
                                <div class="gradient"></div>
                            </div>
                            <a class="d-block mt-2 text-primary text-center" id="more" data-bs-toggle="collapse"
                               href="#moreText" role="button" aria-expanded="false" aria-controls="moreText">
                                Xem thêm
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="book-review-body">
                            <div class="row align-items-center ">
                                ...
                                <div class="col-md-6 text-center">
                                    ...
                                    <p class="text-muted">Vui lòng <a href="${ctx}/auth/login">đăng nhập</a> / <a href="${ctx}/auth/register">đăng ký</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
