...
public class VNPayService {
    ...
    public static final String VNP_RETURN_URL = "http://localhost:8080/order/payment"; // URL return
    public static final String VNP_TMN_CODE = "7E76M52O";
    ...
    public static String getPaymentUrl(HttpServletRequest request, HttpServletResponse response, String groupOrderCode,
            double price)
        ...
        String vnp_TxnRef = groupOrderCode;
        ...
        vnp_Params.put("vnp_OrderInfo", "hmmm" + ": " + price + "đ");
