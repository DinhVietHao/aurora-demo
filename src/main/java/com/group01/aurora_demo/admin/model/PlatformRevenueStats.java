...
public class PlatformRevenueStats {
    ...
    private BigDecimal totalOrderFees; // Phí % theo đơn hàng
    ...
    public PlatformRevenueStats() {
        ...
        this.totalOrderFees = BigDecimal.ZERO;
    ...
    public BigDecimal getTotalOrderFees() {
        return totalOrderFees;
    }

    public void setTotalOrderFees(BigDecimal totalOrderFees) {
        this.totalOrderFees = totalOrderFees;
    }
