...
public class AdminDashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (revenue30Days.compareTo(BigDecimal.ZERO) > 0) {
            ...
            double previousPeriod = revenue30Days.subtract(revenue7Days).doubleValue() / 3; // Average of previous 3
                                                                                            // weeks
        ...
        if (productsPrevious30Days > 0) {
            productChangePercent = ((productsLast30Days - productsPrevious30Days) / (double) productsPrevious30Days) * 100;
        }
